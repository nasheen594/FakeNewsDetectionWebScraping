...
for post in posts:
    ...
    print("-------------------")
    print("Number of words appeared in both the qurey and the article" , wordApperance , "percent of similarity " , appearancePercentage )
    print("link is ", QueryDBActions.getArticleLink(wordApperance_article_id))
    print("------------------------------------------------------------------------------")



    QueryDBActions.updateScore(post[0],wordApperance_article_id,appearancePercentage,cosine_article_id,str(cosineValue),matching_article_id,str(matchingScore))
